...
ref_file = '/Users/dahlek/Desktop/parameterization_tests/CB_cloud_new_pressures/jupiter.ref'
...
file.write('   '+str(pressure_levels)+'    3  \n')
for i in range(0,pressure_levels):
    file.write(str(height[i])+'  1  1  1  1  '+' \n')
file.close()
